...
if __name__ == "__main__":
    ...
    if args.wordcounting_path is not None:
        # conduct word counting...
        wordcounting_path = args.wordcounting_path
        count(wordcounting_path)
    elif args.wordmarking_path is not None:
        # conduct word marking...
        wordmarking_path = args.wordmarking_path
        mark(wordmarking_path)
    else:

        # conduct information extracting and file making...
